...
-- A criação da tabela cidades com uma chave composta foi ilustrativa, para seguir o padrão de termos uma chave primária simples podemos mudar a query para fazer da seguinte forma:
