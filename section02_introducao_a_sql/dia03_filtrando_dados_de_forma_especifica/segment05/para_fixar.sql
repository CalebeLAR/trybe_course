...
SELECT * FROM `sakila`.`payment` WHERE `payment_date` BETWEEN '2005-05-01' AND '2005-08-01' ORDER BY `payment_date`;
...
SELECT `title`,`release_year`,`length` FROM `sakila`.`film` WHERE `rental_duration` BETWEEN 3 AND 6
